...
import { CommentReplyProps } from '.';

const CONTENT_MIN_LENGTH = 10;
const CONTENT_MAX_LENGTH = 200;

export class CommentReplyPolicy extends Policy {
  ...
  public static validate(props: CommentReplyProps): void {
    CommentReplyPolicy.validateContent(props.content);
  }
}
