...
describe('AccountPasswordRecoverService', () => {
  beforeEach(() => {
    ...
    accountDetails = new AccountDetailsEntity({
      id: UUID.generate(),
      props: {
  ...
  describe('requestNewCode', () => {
    ...
    it('should not throw an error when recoverCodeCreatedAt is undefined', async () => {
      const newAccountDetails = new AccountDetailsEntity({
        ...
        props: {
          ...
          activationCodeCreatedAt: DateVO.now().subMinutes(5),
          recoverCode: '123456',
          recoverCodeCreatedAt: undefined,
          account: account.getProps().id,
        },
      });
    ...
    it('should throw an error when account details is not found', async () => {
    ...
    it('should throw an error when recover attempts limit was reached and not enough time passed', async () => {
      const newAccountDetails = new AccountDetailsEntity({
        id: UUID.generate(),
        props: {
          lastSignInAt: undefined,
    ...
    it('should throw an error when recover attempts limit was reached and not enough time passed -5 minutes', async () => {
      const newAccountDetails = new AccountDetailsEntity({
        id: UUID.generate(),
        props: {
          lastSignInAt: undefined,
          ...
          activationCodeCreatedAt: DateVO.now().subMinutes(5),
          recoverCode: '123456',
          recoverCodeCreatedAt: DateVO.now().subMinutes(5),
          account: account.getProps().id,
        },
      });
  ...
  describe('passwordRecover', () => {
    ...
    it('should throw an error if new password is the same as old password', async () => {
      ...
      await expect(AccountPasswordRecoverService.prototype.passwordRecover.call(new AccountPasswordRecoverService(), email, recoverCode!, '@Abc123456')).rejects.toThrowError(ValidationError);
    });

    it('should throw an error when failed recover attempts is greater than max failed recovers', async () => {
      const newAccountDetails = new AccountDetailsEntity({
        id: UUID.generate(),
        props: {
          lastSignInAt: undefined,
    ...
    it('should throw an error if recoverCode is undefined', async () => {
      const newAccountDetails = new AccountDetailsEntity({
        id: UUID.generate(),
        props: {
          lastSignInAt: undefined,
    ...
    it('should throw an error if recoverCodeCreatedAt is undefined', async () => {
      const newAccountDetails = new AccountDetailsEntity({
        id: UUID.generate(),
        props: {
          lastSignInAt: undefined,
    ...
    it('should throw an error if failedRecoverAttempts is greater than max failed recovers', async () => {
      const newAccountDetails = new AccountDetailsEntity({
        id: UUID.generate(),
        props: {
          lastSignInAt: undefined,
